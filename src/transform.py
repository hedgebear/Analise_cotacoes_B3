        ...
        for _, element in context:
            ...
            if ticker:
                dados_ativo = {
                    ...
                    'preco_abertura': Decimal(preco_abertura_el.text) if preco_abertura_el is not None and preco_abertura_el.text else None,
                    'preco_fechamento': Decimal(preco_fechamento_el.text) if preco_fechamento_el is not None and preco_fechamento_el.text else None,
                    'preco_maximo': Decimal(preco_maximo_el.text) if preco_maximo_el is not None and preco_maximo_el.text else None,
                    'preco_minimo': Decimal(preco_minimo_el.text) if preco_minimo_el is not None and preco_minimo_el.text else None,
                    'preco_medio': Decimal(preco_medio_el.text) if preco_medio_el is not None and preco_medio_el.text else None,
